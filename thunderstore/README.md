...
- **ExtraSlots** — dedicated slots for helmet/chest/legs/cape, two utility slots (Megingjord +
  ...
  ExtraSlots. `Tune it:` `[Slots] EquipmentSlots=true`, `UtilitySlots=2`, `FoodSlots=3`, `AmmoSlots=2`, `GenericSlots=2`, `QuickSlots=0`, `AutoEatFromFoodSlots=true`, `AutoEatWhenSecondsLeft=10` (when FoodNoDecay is enabled, wait until active food has this many seconds left)
