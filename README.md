...
1.0.5 is built and tested against Valheim `1.0.12` (network version 40) / BepInEx `5.4.2350`.
For servers held on the `default_pre1_0` branch (0.221.12) use 0.8.8.

Download the maintained fork on [Thunderstore](https://thunderstore.io/c/valheim/p/Fellowship_of_the_Ring/NoVikingLeftBehind/).
