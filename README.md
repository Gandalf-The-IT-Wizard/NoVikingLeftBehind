...
1.0.0 is built and tested against Valheim `1.0.7` (network version 39) / BepInEx `5.4.2350`.
...
Currently `1.0.0`. See [`thunderstore/CHANGELOG.md`](thunderstore/CHANGELOG.md) for the full
